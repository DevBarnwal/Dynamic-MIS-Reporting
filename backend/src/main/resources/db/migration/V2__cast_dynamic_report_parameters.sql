...
SET query = 'SELECT student_roll_no, student_name, department_name, course_name, semester, marks, attendance_percentage, admission_datetime
     FROM student
...
UPDATE dynamic_report
SET query = 'SELECT department_name,
...
WHERE report_name = 'Department Report';

UPDATE dynamic_report
SET query = 'SELECT student_roll_no,
            student_name,
            department_name,
            semester,
            marks,
